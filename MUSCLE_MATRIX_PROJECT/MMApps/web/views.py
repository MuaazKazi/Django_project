...
from MMApps.client.models import Clients,ClientProfile,ClientAddress,ClientMeasurements,ClientSubscription
from MMApps.Masterwork.helpers.check_password import is_valid_password
from MMApps.Masterwork.helpers.JWT_TOKEN import create_jwt_token, decode_jwt_token
from MMApps.Masterwork.helpers.create_otp import generate_otp
from .emailHelper import send_activation_email
...
domain = 'https://musclematrix.pythonanywhere.com/'
...
class WebViews:
    ...
    def terms_of_service_view(self, request):
        return render(request, 'web/terms-and-conditions.html')
...
class AuthViews:
    ...
    def register_view(self, request):
        if request.method == 'POST':
            ...
            mobile_ = request.POST['mobile']
            password_ = request.POST['password']
            confirm_password_ = request.POST['confirm-password']
    ...
    def otp_verification_view(self, request):
            ...
            if Clients.objects.filter(email=email_).exists():
                ...
                if client.otp == otp_:
                    ...
                    if new_password_ != confirm_password_:
                        ...
                        return render(request, 'web/otp-verification.html', {'email': email_})
        ...
        return render(request, 'web/otp-verification.html')
